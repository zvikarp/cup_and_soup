...
class AmountInputWidget extends StatefulWidget {
  ...
  final Function(String, DateTime, int, bool, int) onNoteSubmit;
...
class _AmountInputWidgetState extends State<AmountInputWidget> {
  final TextEditingController _noteInputCtr = TextEditingController();
  ...
  void _onCreateBarcodePressed() {
    ...
    if (msg != "no error") {
      ...
      if (scans == 1) scans = -1;
      widget.onNoteSubmit(
          _noteInputCtr.text, _dateTime, usageLimit, _userLimit, scans);
    }
  }
    ...
    return Column(
      children: <Widget>[
        Padding(
          ...
          child: Text("Please enter the note:",
